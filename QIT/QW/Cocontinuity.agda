...
import QIT.QW.Stage sig propExt as StageBase
import QIT.QW.StageColimit sig propExt as StageColimitBase
...
module WithZ {ℓA} (ZA : ZAlg.Algebra ℓA) where
  ...
  open import QIT.QW.Colimit propExt ≤p ℓD ℓD' hiding (_≈ˡ_)
