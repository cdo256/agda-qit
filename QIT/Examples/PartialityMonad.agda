...
module QIT.Examples.PartialityMonad ⦃ a!c* : A!C ⦄ ⦃ pathElim* : PathElim ⦄ where

open import QIT.Examples.PartialityMonad.Combined
open import QIT.Examples.PartialityMonad.Direct
open import QIT.Examples.PartialityMonad.DirectAlgebra
open import QIT.Examples.PartialityMonad.Erased
open import QIT.Examples.PartialityMonad.ErasedW
-- open import QIT.Examples.PartialityMonad.Flat
open import QIT.Examples.PartialityMonad.MutualAlgebra
