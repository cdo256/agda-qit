...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Fig-01}
\caption{Diagram construction showing bounded depth approximations converging to the quotient-W type.}
\label{fig:diagram}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{mobiles-rough}
\caption{Example mobiles showing tree structures quotiented by permutation at each level.}
\label{fig:mobiles}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{Fig-02}
\caption{Comparison of constructive vs. non-constructive approaches to quotient-W types.}
...
Our results show that the seemingly non-trivial example of infinitary trees can
in fact be proved initial in a fully constructive setting. In particular, we
show that infinite mobiles, previously believed to require choice, admit a
purely constructive construction. This suggests that there may be a large class
of QITs which were previously thought to require choice, but which can in fact
...
to indexed QW types \cite{altenkirch2018-quotient-inductive-inductive}, and
