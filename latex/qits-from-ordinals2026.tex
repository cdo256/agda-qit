...
Fix a supremum signature \(\Sigma=(A,B)\), consisting of a type
...
operation \(\mathsf{sup}: (a:A)\times (B (a)\to Z) \to Z.\)
...
plump algebras over \(\Sigma=(A,B)\). We require an initial algebra
\(Z^e_\Sigma : \mathsf{ExtPlumpAlg} (\Sigma)\) for extensional plump
ordinals.
