...
\subsubsection{Properties of the Plump Ordering}\label{properties-of-the-plump-ordering}
...
\subsection{Mobile Diagram Construction}\label{mobile-diagram-construction}
