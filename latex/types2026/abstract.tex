...
\section{Constructive Quotient-W Types via Bounded
  Locality}\label{constructive-quotient-w-types-via-bounded-locality}
...
Theory \cite{hottl2013-book}. They support a wide range of fundamental
...
that certain QITs, including standard definitions of the countable
...
\subsection{3. Locality Principle}\label{locality-principle}
...
\subsection{4. Main Result}\label{main-result}
...
\subsection{5. Case Study: Infinite
...
\subsection{6. Boundary Phenomena}\label{boundary-phenomena}
...
\subsection{7. Method Overview}\label{method-overview}
