...
\keywords{Quotient Inductive Types, W-Types, Homotopy Type Theory, Agda, Bounded Locality, Constructive Mathematics}
...
\subsection{Locality Principle}\label{locality-principle}
...
\subsection{Case Study: Infinite
...
\subsection{Boundary Phenomena}\label{boundary-phenomena}
