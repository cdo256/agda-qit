...
\begin{frame}{Can we generalise beyond mobiles?}
  ...
  \note{%
    ...
    Depth preservation is a purely syntactic property: you can read it off
    ...
    available — and that is exactly the choice-like strength we are trying
    to avoid.

    Also, bounded syntax alone does not control ordinal strength in general:
    Blass's example (later reframed by Lumsdaine and Shulman) shows that
    apparently controlled equations can still generate large ordinal
    strength.
