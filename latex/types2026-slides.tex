...
\begin{frame}{Can we generalise beyond mobiles?}
  ...
  \note{%
    ...
    The most natural weakenings are bounded depth shift, or locality,
    where both sides of an equation stay below some fixed depth bound.
...
\begin{frame}{Conclusion}
  ...
  \note{%
    ...
    My current working conjecture is that this extra ordinal basis is not
