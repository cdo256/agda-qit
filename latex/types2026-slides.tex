...
\begin{frame}{The story so far}
  \begin{itemize}
    ...
    \item Finitary QIITs reduce to one universal QIIT, the theory of signatures
          (Kaposi--Kov\'acs--Altenkirch 2019).
    \item Large and infinitary QIITs have a general syntax/semantics, but are
          harder to construct (Kov\'acs--Kaposi 2020).
    \item Infinitary QITs are known difficult (Blass 1983, Lumsdaine--Shulman 2018).
...
\begin{frame}{Result for mobiles}
  ...
  from the stagewise argument relative to this basis, without relying on
  the full cocontinuity proof via IWISC.
